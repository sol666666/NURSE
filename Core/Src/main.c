...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
	eMBInit( MB_RTU, 0x03, &huart1, 115200, &htim3 );
	eMBEnable( );
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : Position_Pin Turbine_Pin */
  GPIO_InitStruct.Pin = Position_Pin|Turbine_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);

  /*Configure GPIO pins : Negatescope_Pin WW_Pin Right_Pin Down_Pin
                           Up_Pin Suction_Pin Glass_Pin Light_Pin */
  GPIO_InitStruct.Pin = Negatescope_Pin|WW_Pin|Right_Pin|Down_Pin
                          |Up_Pin|Suction_Pin|Glass_Pin|Light_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : Left_Pin Bowl_Pin End_Pin */
  GPIO_InitStruct.Pin = Left_Pin|Bowl_Pin|End_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
